...
module.exports = {
    ...
    RG: process.env.RG || '2348129956884-1632403322@g.us,120363116963909366@g.us',
    ...
    STICKER_DATA: process.env.STICKER_DATA || "TccMichael",
    BOT_NAME: process.env.BOT_NAME || 'TccMichael',
